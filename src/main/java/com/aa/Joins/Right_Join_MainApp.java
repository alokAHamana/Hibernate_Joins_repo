...
public class Right_Join_MainApp {
	...
	public static void main(String[] args) {
		 ...
		 */
		//this query work as inner join
		//String hql = "SELECT e.empName, d.deptName FROM Employee e LEFT JOIN e.dept d where d is not null";

		String hql = "SELECT e.empName, d.deptName FROM Employee e RIGHT JOIN e.dept d";
